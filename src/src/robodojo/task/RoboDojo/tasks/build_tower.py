...
class BuildTowerCommon:
    ...
    def run_reward(self):
        # Pilot variant: terminate successfully after the first supported layer
        # is complete and both grippers are open.
        self.reward_manager.check(self._score_stage_checks()[0])
