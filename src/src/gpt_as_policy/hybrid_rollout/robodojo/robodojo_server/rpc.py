"""Single-owner blocking RPC; controller disconnects preserve live simulation."""
import json
import socket
import traceback
        ...
        while True:
            ...
            with connection:
                ...
                try:
                    ...
                    terminal = session.terminated or session.truncated

                    session._write_summary(
                        'terminal' if terminal else 'controller_disconnect'
                    )
